...
(function() {
    ...
    String.format || (String.format = function() {
        if (0 == arguments.length)
            return null;
        for (var a = arguments[0] || "", c, i = 1, v = arguments.length; i < v; i++)
            c = RegExp("\\{" + (i - 1) + "\\}", "gm"),
    ...
    Array.prototype.indexOfAttr = function(a, c) {
        for (var i = (typeof a).toLowerCase(), v = -1, b = 0, d = this.length; b < d; b++)
    ...
    var j = "linkScreen", p = "12px Arial", s = 240, t = 320, w = [], E = [], A = "", D = 1, ha = !1, x = 1, f = {
        ...
        keydown: function(a) {
            ...
            d.keyPressCtrl[c] && d.keyPressedGo && (void 0 != d.pressedKey[c] && (d.pressedKey[c] = !0),
            d.keyPressCtrl[c] = !1);
        ...
        keyup: function(a) {
            ...
            d.keyPressedGo && (void 0 != d.pressedKey[c] && (d.pressedKey[c] = !1),
            d.keyPressCtrl[c] = !0);
    ...
    }, k, G, P, Q, H, T, R, U, Y = [], ja = 0, Z = 0, V, M, W, N, m = jsGame = link = {
        init: function(a, c) {
            !a && !c ? (this.version = 1,
            this.request.init(),
            this.canvas.initDevice(),
            this.localStorage.init(),
            this.sessionStorage.init()) : (s = a,
            t = c);
            return this
        },
        ...
        ajax: function(a) {
            ...
            a && a.clear && (r.pool = []);
            r.xhr || (r.xhr = new XMLHttpRequest,
            ...
            if (null == r.xhrObj && 0 < r.pool.length) {
                ...
                r.date = setTimeout(function() {
                    ...
                    r.isTimeout = !0;
                    r.xhrObj && (r.xhrObj.error(r.xhrObj, "timeout"),
                    r.xhrObj = null)
                }, r.xhrObj.timeout)
            }
            return this
            ...
            if ("object" == typeof c)
                if (void 0 != c.length)
                    for (var a = [], i = 0, b = c.length; i < b; i++)
                        void 0 !== c[i] && (a[i] = null != c[i] && "object" == typeof c[i] ? void 0 != c[i].length ? c[i].slice(0) : c[i] : c[i]);
                else
                    for (i in a = {},
                    c)
                        void 0 !== c[i] && (a[i] = null != c[i] && "object" == typeof c[i] ? void 0 != c[i].length ? c[i].slice(0) : c[i] : c[i]);
        ...
        comm: {
            ...
            getRandom: function(a, c) {
                if (c)
                    return Math.round(Math.random() * (c - a) + a);
                var i = a;
                if (!i || 0 > i)
                    i = 0;
            ...
            createPath: function(a, c, i, b, d) {
                for (var e = [], a = (i || 0) - (a || 0), g = (b || 0) - (c || 0), c = Math.sqrt(Math.pow(a, 2) + Math.pow(g, 2)), b = d = d || 5, h = i = 0, f = 180 * (Math.atan2(g, a) / Math.PI), f = 0 <= f ? f : f + 360; b < c + d; )
                    b = b > c ? c : b,
        ...
        pageLoad: function(a) {
            ...
            window.addEventListener("load", function() {
                ...
                a && (m.canvas.screen.getTouch() ? (window.addEventListener("orientationchange", l.orientationchange, !1),
                ...
                a.addEventListener("touchcancel", l.touchcancel, !1)) : (document.onkeydown = l.keydown,
                ...
                "ipad" == a || "iphone" == a ? (d.focused = !0,
                window.addEventListener("pageshow", l.pageFocus, !1),
                window.addEventListener("pagehide", l.pageUnFocus, !1)) : ("firefox" == a && (d.focused = !0),
        ...
        play: function() {
            ...
            f.playTimer || (f.isPause = !1,
            (f.rafRun = function() {
                var a = Date.now();
                a - f.lastDate >= f.timeout - f.spendTime && (f.lastDate = a,
                f.isPause || f.run());
        ...
        gameFlow: {
            menu: function() {
                null != f.menu && (f.gameFlow = z.menu,
                m.resetKeys());
                return this
            },
            run: function() {
                null != f.runFn && (f.gameFlow = z.run,
                m.resetKeys());
                return this
            },
            stop: function() {
                null != f.stop && (f.gameFlow = z.stop,
                m.resetKeys());
                return this
            },
            over: function() {
                null != f.over && (f.gameFlow = z.over,
                m.resetKeys());
                return this
            },
            zone: function(a) {
                null != f.zone && (f.gameFlow = z.zone,
                f.zoneArgs = a,
                m.resetKeys());
                return this
            },
            active: function(a) {
                null != f.active && (f.gameFlow = z.active,
                f.activeArgs = a,
                m.resetKeys());
                return this
            },
        ...
        resetKeys: function() {
            ...
            for (a in d.lastKey)
                d.lastKey[a] = !1;
            for (a in d.pressedKey)
                d.pressedKey[a] = !1;
            for (a in d.keyPressCtrl)
                d.keyPressCtrl[a] = !0;
            return this
        },
        canvas: {
            ...
            pass: function(a, c, i) {
                ...
                E[a] || (b = this.base().getDom(a) || document.createElement("canvas"),
                E[a] = null,
                delete E[a],
                E[a] = b.getContext("2d"),
                b.width = c ? c : s,
            ...
            fillRect: function(a, c, i, b, d) {
                i = i ? i : 0;
                b = b ? b : 0;
                d ? Q = l.getAnchor(a, c, i, b, d) : (Q.x = a,
                Q.y = c);
            ...
            strokeRect: function(a, c, i, b, d) {
                d ? P = l.getAnchor(a, c, i, b, d) : (P.x = a,
                P.y = c);
            ...
            setColor: function(a, c, i) {
                null == i ? (e = a,
                n = c ? c : a) : n = e = "rgb(" + a + ", " + c + ", " + i + ")";
                return this.fillStyle(e).strokeStyle(n)
            },
            drawImage: function(a, c, i, b, d, e, g, h, f, q) {
                var j = m.getImage(a);
                if (j.refreshed)
                    this.drawCache(a, c, i, b, d, e, g, h, f, q);
                else if (null != j.src)
                    null != h && (c = 0 > c ? 0 : c,
                    h = 0 >= h ? 0.1 : h),
                    null != f && (i = 0 > i ? 0 : i,
                    f = 0 >= f ? 0.1 : f),
                    null != b && null != h && (b = 0 >= b ? 0.1 : c + b <= j.width ? b : j.width - c),
                    null != d && null != f && (d = 0 >= d ? 0.1 : i + d <= j.height ? d : j.height - i),
                    j.loaded && (b ? d ? q ? (G = l.getAnchor(e, g, h, f, q),
                    k.drawImage(j, c, i, b, d, G.x, G.y, h, f)) : k.drawImage(j, c, i, b, d, e, g, h, f) : (G = l.getAnchor(c, i, j.width, j.height, b),
                    k.drawImage(j, G.x, G.y)) : k.drawImage(j, c, i));
            ...
            drawCache: function(a, c, b, d, e, g, h, f, j, q) {
                if (a = w[a])
                    ...
                    null != j && (b = 0 > b ? 0 : b,
                    j = 0 >= j ? 0.1 : j),
                    null != d && null != f && (d = 0 >= d ? 0.1 : c + d <= a.width ? d : a.width - c),
                    null != e && null != j && (e = 0 >= e ? 0.1 : b + e <= a.height ? e : a.height - b),
                    d ? e ? q ? (G = l.getAnchor(g, h, f, j, q),
                    k.drawImage(a, c, b, d, e, G.x, G.y, f, j)) : k.drawImage(a, c, b, d, e, g, h, f, j) : (G = l.getAnchor(c, b, a.width, a.height, d),
                    k.drawImage(a, G.x, G.y)) : k.drawImage(a, c, b);
                return this
            },
            ...
            drawNumber: function(a, c, b, d, e, g, f, h, j) {
                ...
                if ("center" == f) {
                    e += parseInt(R - h * q >> 1);
                    for (f = 0; f < q; f++)
                        this.drawImage(c, parseInt(a.charAt(f)) * b, 0, b, d, e + f * h, g, h, j)
                } else if (!0 == f)
                    for (f = 0; f < q; f++)
                        this.drawImage(c, parseInt(a.charAt(f)) * b, 0, b, d, e + f * h, g, h, j);
                else if (!1 == f)
                    for (f = q - 1; 0 <= f; f--)
                        this.drawImage(c, parseInt(a.charAt(f)) * b, 0, b, d, e - (q - 1 - f) * h, g, h, j, m.graphics.ANCHOR_RT);
                return this
            },
            moveTo: function(a, c) {
                k.moveTo(a, c);
            ...
            drawString: function(a, c, d, e, f, h, j, q) {
                ...
                f && (C = h ? h : "#000000",
                b = j ? j : "#CCCCCC",
                this.fillStyle(b).fillText(a, g + 1, B + 1, q).fillStyle(C));
        ...
        audio: {
            ...
            del: function(a) {
                var c = y[a];
                c && c.__timeupdateCallBack__ && (c.pause(),
                c.removeEventListener("timeupdate", c.__timeupdateCallBack__, !1),
                y[a] = null,
                delete y[a]);
                return this
            },
        ...
        initAudio: function(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c, b = 0; b < a.length; b++)
                    (c = a[b]) && l.setAudio(c.id, c.src, c.loop, c.autoplay, c.preload, c.autobuffer)
            }
            return this
        },
...
(function(g) {
    ...
    link.action.Role.prototype.action = function() {
        ...
        if (e) {
            ...
            if (0 < this._path.length)
                ...
                this._skipMoveDs || (this.setSprite(this._stopedAction || this._stopDs[B(this.svx, this.svy)]),
            ...
            0 < this._zooms.length && (g = this._zooms.shift(),
            "number" == typeof parseInt(g) && this.setZoom(g));
            0 < this._angles.length && (g = this._angles.shift(),
    ...
    link.action.Role.prototype.render = function() {
        ...
        if (b && this._fA) {
            ...
            e[0] && (j = this.x,
            p = this.y,
            g.canvas.save().translate(j, p).rotate(this.angle * Math.PI / 180).translate(-j, -p));
            for (var t = 0; t < n; t++)
                j = this.rects[e[t][0]][e[t][1]],
                p = this.imageNames[e[t][0]],
                s = g.getImage(p),
                b == g.trans.TRANS_NONE ? h.drawImage(p, j[0], j[1], j[2], j[3], 1 == this.zoom ? parseInt(this.x + this.dx + e[t][2] * this.zoom) : this.x + this.dx + e[t][2] * this.zoom, 1 == this.zoom ? parseInt(this.y + this.dy + e[t][3] * this.zoom) : this.y + this.dy + e[t][3] * this.zoom, j[2] * this.zoom, j[3] * this.zoom) : 1 == this.zoom ? h.drawRegion(p, j[0], j[1], j[2], j[3], b, parseInt(this.x + this.dx - (e[t][2] + j[2])), parseInt(this.y + this.dy + e[t][3])) : h.drawRegionAndZoom(p, j[0], j[1], j[2], j[3], b, this.x + this.dx - (e[t][2] + j[2]) * this.zoom, this.y + this.dy + e[t][3] * this.zoom, null, j[2] * this.zoom, j[3] * this.zoom),
                !s.loaded && s.bench && h.drawImage(s.bench.id || s.benchId, s.bench.sx || 0, s.bench.sy || 0, s.bench.sw || s.bench.w, s.bench.sh || s.bench.h, parseInt(this.x + this.dx - (s.bench.w * this.zoom >> 1)), parseInt(this.y + this.dy - s.bench.h * this.zoom), s.bench.w * this.zoom, s.bench.h * this.zoom);
    ...
    link.action.Role.prototype.collision = function(b, e, n) {
        ...
        return h && j ? g.comm.collision(this.getSprite().trans == g.trans.TRANS_NONE ? parseInt(this.x + this.dx + h[0] * this.zoom) : parseInt(this.x + this.dx - (h[0] + h[2]) * this.zoom), parseInt(this.y + this.dy + h[1] * this.zoom), parseInt(h[2] * this.zoom), parseInt(h[3] * this.zoom), b.getSprite().trans == g.trans.TRANS_NONE ? parseInt(b.x + b.dx + j[0] * b.zoom) : parseInt(b.x + b.dx - (j[0] + j[2]) * b.zoom), parseInt(b.y + b.dy + j[1] * b.zoom), parseInt(j[2] * b.zoom), parseInt(j[3] * b.zoom)) : !1
    }
    ;
    link.action.Role.prototype.collisionInput = function(b, e, n, h, j) {
        var j = j || "aR", p;
        "aR" == j ? p = this.aR : "bR" == j && (p = this.bR);
        return p ? g.comm.collision(this.getSprite().trans == g.trans.TRANS_NONE ? parseInt(this.x + this.dx + p[0] * this.zoom) : parseInt(this.x + this.dx - (p[0] + p[2]) * this.zoom), parseInt(this.y + this.dy + p[1] * this.zoom), parseInt(p[2] * this.zoom), parseInt(p[3] * this.zoom), b, e, n, h) : !1
    }
    ;
    ...
    link.action.Role.prototype.setPath = function(b, e) {
        this._path = b || [];
        if (0 < this._path.length && this.onstart)
            this.onstart(this);
    ...
    link.action.Sprite.prototype.nextFrame = function() {
        if (!this.loop && this.endFrame())
            return this;
        0 < this.frames.length && (0 >= this.runStep ? (this.loop ? (this.current++,
        this.current %= this.frames.length) : this.current < this.frames.length - 1 && this.current++,
        this.runStep = this.getFrame().step ? this.getFrame().step : this.step) : this.runStep--);
        return this
    }
    ;
    link.action.Sprite.prototype.preFrame = function() {
        0 < this.frames.length && (0 >= this.runStep ? (this.loop ? (this.current--,
        0 > this.current && (this.current = this.frames.length - 1)) : 0 < this.current && this.current--,
        this.runStep = this.getFrame().step ? this.getFrame().step : this.step) : this.runStep--);
        return this
    }
    ;
    ...
    link.action.Fragment.prototype.queue = function() {
        0 < this.sprites.length ? 0 < this.sprites[0].frames.length && (0 >= this.sprites[0].runStep ? (this.sprites[0].runStep = this.sprites[0].step,
        C = this.sprites[0].frames.shift(),
        0 == this.sprites[0].frames.length && this.sprites.shift()) : (C = this.sprites[0].getFrame(),
        this.sprites[0].runStep--)) : C = null;
        return C
    }
    ;
...
(function(g) {
    ...
    g.pageLoad(function() {
        ...
        window.scrollTo(0, 1);
        var w, E;
        g.canvas.screen.setHeight(550 < window.innerHeight ? 550 : window.innerHeight);
        ...
        A = {
            Button: g.extend(function(b) {
                ...
                collision: function(b, d, e, f, h) {
                    ...
                    if (g.comm.collision(b, d, e, f, parseInt(this.props.x), parseInt(this.props.y), parseInt(this.props.width), parseInt(this.props.height))) {
                        switch (h) {
                        case "mousedown":
                        case "touchstart":
                ...
                render: function() {
                    this.props.img ? g.canvas.drawImage(this.props.img.id, this.props.img.sx, this.props.img.sy, this.props.img.sw, this.props.img.sh, parseInt(this.props.x), parseInt(this.props.y), parseInt(this.props.width), parseInt(this.props.height)) : "" != this.props.bgColor && g.canvas.fillStyle(this.props.bgColor).fillRect(parseInt(this.props.x), parseInt(this.props.y), parseInt(this.props.width), parseInt(this.props.height));
                    if ("" != this.props.value) {
                        var b = g.canvas.measureText(this.props.value);
                        g.canvas.drawString(this.props.value, parseInt(this.props.x + (this.props.width - b.width >> 1)), parseInt(this.props.y + (this.props.height - b.height >> 1)) + b.height - 2, "", !0, this.props.color, this.props.strokeColor, this.props.font)
                    }
                    return this
                }
            }),
        ...
        var B = g.canvas.screen.getDevice(), x = {
            ...
            bgRender: function() {
                g.canvas.fillStyle(this.bgColor).fillScreen().drawCache("bgCache", this.bgX, this.bgY);
                return this
            },
            gameOver: function() {
                this.screenFade();
            ...
            screenFade: function() {
                this.isGameOver || (this.screenFlush = [1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0],
                g.audio.pauseAll().playRange("sound1", 5, 6),
                window.dp_submitScore && dp_submitScore(g.localStorage.getItem("FlappyBirdBestScore"), x.score));
                return this
            },
            initObses: function() {
                this.obses = [];
            ...
            objesAction: function() {
                ...
                case "run":
                    for (var b = this.obses.length - 1, d; d = this.obses[b]; b--)
                        d.x += this.speed,
                        this.bird.collisionInput(d.x, d.y, d.width, d.height, "bR") && this.gameOver(),
                        -52 >= d.x && this.obses.splice(b, 1);
                    this.obsCurrentFrame++ == this.obsFrameNum && (this.obsCurrentFrame = 0,
                    this.obsDate = _newDate,
                    this.popObs())
                }
                if ((b = this.obses[0]) && b.id != this.scoreObsId && b.x < this.bird.x - 26)
                    this.scoreObsId = b.id,
                    this.score++;
                return this
            },
            objesRender: function() {
                for (var b, d = 0, e; e = this.obses[d]; d++)
                    b = e.imgObj,
                    g.canvas.drawImage(b.id, b.sx, b.sy, b.width, b.height, e.x, e.y, b.width, b.height);
                return this
            },
            ...
            birdJump: function() {
                this.isGameOver || (this.vy = this.jumpSpeed,
                g.audio.playRange("sound1", 0, 1));
                return this
            },
            birdAction: function() {
                if (this.bird)
                    switch (this.bird.action(),
                    this.bird.state) {
                    case "waiting":
                    ...
                    case "flying":
                        this.vy += this.g;
                        if (this.bird.collisionInput(0, this.bgHeight - this.landH - this.vy, this.landW, this.landH, "bR")) {
            ...
            screenFlushRender: function() {
                0 < this.screenFlush.length && (g.canvas.fillStyle("rgba(255, 255, 255, " + this.screenFlush.shift() + ")").fillScreen(),
                0 == this.screenFlush.length && (g.audio.playRange("sound1", 7, 8),
                A.clearButtons(),
                b = 0,
                e = -1,
                (g.localStorage.getItem("FlappyBirdBestScore") || 0) < x.score ? (g.localStorage.setItem("FlappyBirdBestScore", x.score),
                n = !0) : n = !1,
                h = parseInt(g.localStorage.getItem("FlappyBirdBestScore") || 0),
                j = d,
                p = [-3, -2, -1, 1, 2, 3],
                s = d + 500,
            ...
            action: function() {
                0 < this.values.length && (this.opacity = this.values.shift(),
        ...
        g.run(function() {
            ...
            switch (b) {
            case 0:
                0 < p.length ? j += p.shift() : 0 < t.length ? s += t.shift() : b = 1;
                break;
            case 1:
                e++;
                e >= x.score && (b = 2);
            ...
            case 2:
                A.renderButton(),
                n && g.canvas.drawImage("s2", 224, 486, 32, 14, f + 68, d + 146, 32, 14)
            }
...
(function(g) {
    ...
    var B = ["s2"]
      ...
      , e = [{
        ...
        loop: !0,
        frames: [[6, 0, 0, 0], [7, 0, 0, 0], [8, 0, 0, 0], [7, 0, 0, 0]]
    }];
    FlappyBirdNameSpace.get = function(n, h) {
        return new g.action.role([],0,0,0,h ? h : B,C,b,(0 <= n && e[n] ? [e[n]] : e) || e)
    }
    ;
